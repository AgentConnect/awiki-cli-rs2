...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1838815190;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  DartGroupSummary dco_decode_dart_group_summary(dynamic raw) {
    ...
    return DartGroupSummary(
      ...
      did: dco_decode_String(arr[1]),
      name: dco_decode_opt_String(arr[2]),
      myRole: dco_decode_opt_String(arr[3]),
      membershipStatus: dco_decode_opt_String(arr[4]),
      memberCount: dco_decode_opt_box_autoadd_u_32(arr[5]),
      lastMessageAt: dco_decode_opt_String(arr[6]),
    );
  }
