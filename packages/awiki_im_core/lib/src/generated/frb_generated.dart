...
abstract class RustLibApi extends BaseApi {
  ...
  Future<DartDaemonSubkeyPublicPackage> crateApiIdentityAuthorizeDaemonSubkey({
    required ArcDartImCore core,
    required DartIdentitySelector selector,
  ...
  Future<bool> crateApiAttachmentsCancelAttachmentDownload({
  ...
  Future<void> crateApiMessagesCloseProcessingSession({
    required ArcDartMessageProcessingSession session,
  });

  Future<DartDeleteLocalIdentityResult>
  crateApiIdentityCompleteLocalIdentityDataDeletion({
    required ArcDartImCore core,
  ...
  crateApiIdentityConfirmDeviceJoinWithManagement({
    required ArcDartImCore core,
    required String approvalHandle,
    required bool userPresenceConfirmed,
  });
  ...
  Future<DartDeleteLocalIdentityResult>
  crateApiIdentityDeleteLocalIdentityData({
    required ArcDartImCore core,
    required DartIdentitySelector selector,
  });

  Future<List<DartDeviceJoinManagementStatus>>
  crateApiIdentityDeviceJoinManagementStatus({
    required ArcDartImCore core,
    required DartIdentitySelector selector,
  });
  ...
  Future<bool> crateApiIdentityHasPendingLocalIdentityRecovery({
    required ArcDartImCore core,
    required DartIdentitySelector selector,
  });
  ...
  Future<List<String>> crateApiIdentityIdentityCreationMethods({
    required ArcDartImCore core,
  });

  Future<DartIdentityCustodyStatus> crateApiIdentityIdentityCustodyStatus({
    required ArcDartImCore core,
    required DartIdentitySelector selector,
  });
  ...
  Future<String> crateApiIdentityIdentityDocument({
    required ArcDartImCore core,
    required DartIdentitySelector selector,
  });

  Future<String> crateApiIdentityIdentityMethodCapabilities({
    required String did,
  });

  Future<bool> crateApiIdentityIdentityServicesUpdatePending({
    required ArcDartImCore core,
    required DartIdentitySelector selector,
  });
  ...
  Future<DartHandleRecoveryContext>
  crateApiIdentityInspectHandleRecoveryContext({
    required ArcDartImCore core,
  ...
  Future<DartMessagePage> crateApiMessagesLocalIncomingRecovery({
    required ArcDartImClient client,
    required int limit,
    String? cursor,
  });
  ...
  Stream<DartMessageProcessingUpdate> crateApiMessagesMessageProcessingStream({
    required ArcDartMessageProcessingSession session,
  });
  ...
  Future<ArcDartMessageProcessingSession>
  crateApiMessagesOpenProcessingSession({required ArcDartImClient client});

  Future<String> crateApiIdentityPendingIdentityRegistrations({
    required ArcDartImCore core,
  });

  Future<List<DartLocalIdentityDeletionTicket>>
  crateApiIdentityPendingLocalIdentityDataDeletions({
    required ArcDartImCore core,
  });

  Future<List<DartMessageProcessingUpdate>> crateApiMessagesPendingProcessing({
    required ArcDartImClient client,
    required int limit,
  });
  ...
  Future<DartLocalIdentityDeletionTicket>
  crateApiIdentityPrepareLocalIdentityDataDeletion({
    required ArcDartImCore core,
    required DartIdentitySelector selector,
  });
  ...
  Future<DartMessageReceiveOutcome> crateApiMessagesReceiveNow({
    required ArcDartImClient client,
    required DartMessageSyncRequest request,
  });

  Future<List<DartDisplayProfile>> crateApiDirectoryRefreshDisplayProfiles({
    required ArcDartImClient client,
    required List<String> peers,
    required bool force,
  });
  ...
  Future<bool> crateApiMessagesRefreshLocalSyncAuthorization({
    required ArcDartImClient client,
  });
  ...
  Future<String> crateApiIdentityResolveHandleForDeviceJoin({
    required ArcDartImCore core,
    required String handle,
  });
  ...
  Future<void> crateApiIdentityRetryDeviceJoinManagement({
    required ArcDartImCore core,
    required DartIdentitySelector selector,
    required String joinSessionId,
  });
  ...
  Future<int> crateApiMessagesRetryProcessing({
    required ArcDartImClient client,
  ...
  Future<String> crateApiIdentityUpdateIdentityServices({
    required ArcDartImCore core,
    required DartIdentitySelector selector,
    String? servicesJson,
  });
  ...
  Future<DartMessageProcessingOutcome> crateApiMessagesWaitMessageProcessing({
    required ArcDartMessageProcessingSession session,
  });
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_ArcDartMessageProcessingSession;

  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_ArcDartMessageProcessingSession;

  CrossPlatformFinalizerArg
  get rust_arc_decrement_strong_count_ArcDartMessageProcessingSessionPtr;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_dart_identity_selector(selector, serializer);
          sse_encode_box_autoadd_dart_daemon_subkey_public_proposal(
            proposal,
            serializer,
          );
          pdeCallFfi(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_dart_daemon_subkey_public_package,
          decodeErrorData: sse_decode_dart_im_error,
        ),
        constMeta: kCrateApiIdentityAuthorizeDaemonSubkeyConstMeta,
        argValues: [core, selector, proposal],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiIdentityAuthorizeDaemonSubkeyConstMeta =>
      const TaskConstMeta(
        debugName: "authorize_daemon_subkey",
        argNames: ["core", "selector", "proposal"],
      );
  ...
  Future<bool> crateApiAttachmentsCancelAttachmentDownload({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAttachmentsCancelAttachmentDownloadConstMeta,
  ...
  TaskConstMeta get kCrateApiAttachmentsCancelAttachmentDownloadConstMeta =>
      const TaskConstMeta(
        debugName: "cancel_attachment_download",
  ...
  Future<void> crateApiMessagesCloseProcessingSession({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMessagesCloseProcessingSessionConstMeta,
        argValues: [session],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMessagesCloseProcessingSessionConstMeta =>
      const TaskConstMeta(
        debugName: "close_processing_session",
        argNames: ["session"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(deletionId, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 20,
        ...
        constMeta: kCrateApiIdentityCompleteLocalIdentityDataDeletionConstMeta,
        argValues: [core, deletionId],
        apiImpl: this,
      ),
    );
  }
  ...
  TaskConstMeta
  get kCrateApiIdentityCompleteLocalIdentityDataDeletionConstMeta =>
      const TaskConstMeta(
        debugName: "complete_local_identity_data_deletion",
        argNames: ["core", "deletionId"],
      );
  ...
  crateApiIdentityConfirmDeviceJoinWithManagement({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityConfirmDeviceJoinWithManagementConstMeta,
        argValues: [core, approvalHandle, userPresenceConfirmed],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityConfirmDeviceJoinWithManagementConstMeta =>
      const TaskConstMeta(
        debugName: "confirm_device_join_with_management",
        argNames: ["core", "approvalHandle", "userPresenceConfirmed"],
      );
  ...
  crateApiIdentityDeleteLocalIdentityData({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityDeleteLocalIdentityDataConstMeta,
        argValues: [core, selector],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityDeleteLocalIdentityDataConstMeta =>
      const TaskConstMeta(
        debugName: "delete_local_identity_data",
        argNames: ["core", "selector"],
      );
  ...
  crateApiIdentityDeviceJoinManagementStatus({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_dart_device_join_management_status,
          decodeErrorData: sse_decode_dart_im_error,
        ),
        constMeta: kCrateApiIdentityDeviceJoinManagementStatusConstMeta,
        argValues: [core, selector],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityDeviceJoinManagementStatusConstMeta =>
      const TaskConstMeta(
        debugName: "device_join_management_status",
        argNames: ["core", "selector"],
      );
  ...
  Future<bool> crateApiIdentityHasPendingLocalIdentityRecovery({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityHasPendingLocalIdentityRecoveryConstMeta,
        argValues: [core, selector],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityHasPendingLocalIdentityRecoveryConstMeta =>
      const TaskConstMeta(
        debugName: "has_pending_local_identity_recovery",
        argNames: ["core", "selector"],
      );
  ...
  Future<List<String>> crateApiIdentityIdentityCreationMethods({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityIdentityCreationMethodsConstMeta,
        argValues: [core],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityIdentityCreationMethodsConstMeta =>
      const TaskConstMeta(
        debugName: "identity_creation_methods",
        argNames: ["core"],
      );
  ...
  Future<DartIdentityCustodyStatus> crateApiIdentityIdentityCustodyStatus({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_dart_identity_custody_status,
          decodeErrorData: sse_decode_dart_im_error,
        ),
        constMeta: kCrateApiIdentityIdentityCustodyStatusConstMeta,
        argValues: [core, selector],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityIdentityCustodyStatusConstMeta =>
      const TaskConstMeta(
        debugName: "identity_custody_status",
        argNames: ["core", "selector"],
      );
  ...
  Future<String> crateApiIdentityIdentityDocument({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityIdentityDocumentConstMeta,
        argValues: [core, selector],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityIdentityDocumentConstMeta =>
      const TaskConstMeta(
        debugName: "identity_document",
        argNames: ["core", "selector"],
      );
  ...
  Future<String> crateApiIdentityIdentityMethodCapabilities({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityIdentityMethodCapabilitiesConstMeta,
        argValues: [did],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityIdentityMethodCapabilitiesConstMeta =>
      const TaskConstMeta(
        debugName: "identity_method_capabilities",
        argNames: ["did"],
      );
  ...
  Future<bool> crateApiIdentityIdentityServicesUpdatePending({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityIdentityServicesUpdatePendingConstMeta,
        argValues: [core, selector],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityIdentityServicesUpdatePendingConstMeta =>
      const TaskConstMeta(
        debugName: "identity_services_update_pending",
        argNames: ["core", "selector"],
      );
  ...
  crateApiIdentityInspectHandleRecoveryContext({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_dart_handle_recovery_context,
          decodeErrorData: sse_decode_dart_im_error,
        ),
        constMeta: kCrateApiIdentityInspectHandleRecoveryContextConstMeta,
        argValues: [core, fullHandle, selector],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiIdentityInspectHandleRecoveryContextConstMeta =>
      const TaskConstMeta(
        debugName: "inspect_handle_recovery_context",
        argNames: ["core", "fullHandle", "selector"],
      );
  ...
  Future<DartMessagePage> crateApiMessagesLocalIncomingRecovery({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMessagesLocalIncomingRecoveryConstMeta,
        argValues: [client, limit, cursor],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMessagesLocalIncomingRecoveryConstMeta =>
      const TaskConstMeta(
        debugName: "local_incoming_recovery",
        argNames: ["client", "limit", "cursor"],
      );
  ...
  Stream<DartMessageProcessingUpdate> crateApiMessagesMessageProcessingStream({
    ...
    final sink = RustStreamSink<DartMessageProcessingUpdate>();
    unawaited(
      handler.executeNormal(
        NormalTask(
          callFfi: (port_) {
            ...
            sse_encode_StreamSink_dart_message_processing_update_Sse(
              sink,
              serializer,
            );
            pdeCallFfi(
          ...
          constMeta: kCrateApiMessagesMessageProcessingStreamConstMeta,
          argValues: [session, sink],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta get kCrateApiMessagesMessageProcessingStreamConstMeta =>
      const TaskConstMeta(
        debugName: "message_processing_stream",
        argNames: ["session", "sink"],
      );
  ...
  crateApiMessagesOpenProcessingSession({required ArcDartImClient client}) {
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMessagesOpenProcessingSessionConstMeta,
        argValues: [client],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMessagesOpenProcessingSessionConstMeta =>
      const TaskConstMeta(
        debugName: "open_processing_session",
        argNames: ["client"],
      );
  ...
  Future<String> crateApiIdentityPendingIdentityRegistrations({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityPendingIdentityRegistrationsConstMeta,
        argValues: [core],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityPendingIdentityRegistrationsConstMeta =>
      const TaskConstMeta(
        debugName: "pending_identity_registrations",
        argNames: ["core"],
      );
  ...
  crateApiIdentityPendingLocalIdentityDataDeletions({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityPendingLocalIdentityDataDeletionsConstMeta,
        argValues: [core],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiIdentityPendingLocalIdentityDataDeletionsConstMeta =>
      const TaskConstMeta(
        debugName: "pending_local_identity_data_deletions",
        argNames: ["core"],
      );
  ...
  Future<List<DartMessageProcessingUpdate>> crateApiMessagesPendingProcessing({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_list_dart_message_processing_update,
          decodeErrorData: sse_decode_dart_im_error,
        ),
        constMeta: kCrateApiMessagesPendingProcessingConstMeta,
        argValues: [client, limit],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMessagesPendingProcessingConstMeta =>
      const TaskConstMeta(
        debugName: "pending_processing",
        argNames: ["client", "limit"],
      );
  ...
  crateApiIdentityPrepareLocalIdentityDataDeletion({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_dart_local_identity_deletion_ticket,
          decodeErrorData: sse_decode_dart_im_error,
        ),
        constMeta: kCrateApiIdentityPrepareLocalIdentityDataDeletionConstMeta,
        argValues: [core, selector],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta
  get kCrateApiIdentityPrepareLocalIdentityDataDeletionConstMeta =>
      const TaskConstMeta(
        debugName: "prepare_local_identity_data_deletion",
        argNames: ["core", "selector"],
      );
  ...
  Future<DartMessageReceiveOutcome> crateApiMessagesReceiveNow({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_dart_message_receive_outcome,
          decodeErrorData: sse_decode_dart_im_error,
        ),
        constMeta: kCrateApiMessagesReceiveNowConstMeta,
        argValues: [client, request],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMessagesReceiveNowConstMeta => const TaskConstMeta(
    debugName: "receive_now",
    argNames: ["client", "request"],
  );
  ...
  Future<List<DartDisplayProfile>> crateApiDirectoryRefreshDisplayProfiles({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiDirectoryRefreshDisplayProfilesConstMeta,
        argValues: [client, peers, force],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiDirectoryRefreshDisplayProfilesConstMeta =>
      const TaskConstMeta(
        debugName: "refresh_display_profiles",
        argNames: ["client", "peers", "force"],
      );
  ...
  Future<bool> crateApiMessagesRefreshLocalSyncAuthorization({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMessagesRefreshLocalSyncAuthorizationConstMeta,
        argValues: [client],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMessagesRefreshLocalSyncAuthorizationConstMeta =>
      const TaskConstMeta(
        debugName: "refresh_local_sync_authorization",
        argNames: ["client"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_opt_String(didMethod, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 111,
  ...
  Future<String> crateApiIdentityResolveHandleForDeviceJoin({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityResolveHandleForDeviceJoinConstMeta,
        argValues: [core, handle],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiIdentityResolveHandleForDeviceJoinConstMeta =>
      const TaskConstMeta(
        debugName: "resolve_handle_for_device_join",
        argNames: ["core", "handle"],
      );
  ...
  Future<void> crateApiIdentityRetryDeviceJoinManagement({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiIdentityRetryDeviceJoinManagementConstMeta,
        argValues: [core, selector, joinSessionId],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiIdentityRetryDeviceJoinManagementConstMeta =>
      const TaskConstMeta(
        debugName: "retry_device_join_management",
        argNames: ["core", "selector", "joinSessionId"],
      );
  ...
  Future<int> crateApiMessagesRetryProcessing({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMessagesRetryProcessingConstMeta,
        argValues: [client, eventId],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMessagesRetryProcessingConstMeta =>
      const TaskConstMeta(
        debugName: "retry_processing",
        argNames: ["client", "eventId"],
      );
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_box_autoadd_dart_identity_selector(selector, serializer);
          sse_encode_opt_String(servicesJson, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 155,
        ...
        constMeta: kCrateApiIdentityUpdateIdentityServicesConstMeta,
        argValues: [core, selector, servicesJson],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiIdentityUpdateIdentityServicesConstMeta =>
      const TaskConstMeta(
        debugName: "update_identity_services",
        argNames: ["core", "selector", "servicesJson"],
      );
  ...
  Future<DartMessageProcessingOutcome> crateApiMessagesWaitMessageProcessing({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_dart_message_processing_outcome,
          decodeErrorData: sse_decode_dart_im_error,
        ),
        constMeta: kCrateApiMessagesWaitMessageProcessingConstMeta,
        argValues: [session],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMessagesWaitMessageProcessingConstMeta =>
      const TaskConstMeta(
        debugName: "wait_message_processing",
        argNames: ["session"],
      );
  ...
  RustArcIncrementStrongCountFnType
  get rust_arc_increment_strong_count_ArcDartMessageProcessingSession => wire
  ...
  RustArcDecrementStrongCountFnType
  get rust_arc_decrement_strong_count_ArcDartMessageProcessingSession => wire
  ...
  dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerArcDartMessageProcessingSession(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return ArcDartMessageProcessingSessionImpl.frbInternalDcoDecode(
      raw as List<dynamic>,
    );
  }
  ...
  dco_decode_box_autoadd_dart_daemon_subkey_public_proposal(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_dart_daemon_subkey_public_proposal(raw);
  }
  ...
  dco_decode_box_autoadd_dart_handle_recovery_operation_summary(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_dart_handle_recovery_operation_summary(raw);
  }
  ...
  dco_decode_box_autoadd_dart_handle_recovery_progress(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_dart_handle_recovery_progress(raw);
  }
  ...
  DartDaemonSubkeyPublicPackage dco_decode_dart_daemon_subkey_public_package(
    ...
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return DartDaemonSubkeyPublicPackage(
      ...
      keyAlgorithm: dco_decode_String(arr[4]),
  ...
  DartDaemonSubkeyPublicProposal dco_decode_dart_daemon_subkey_public_proposal(
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return DartDaemonSubkeyPublicProposal(
      userDid: dco_decode_String(arr[0]),
      verificationMethod: dco_decode_String(arr[1]),
      publicKeyMultibase: dco_decode_String(arr[2]),
    );
  }
  ...
  DartDeviceJoinManagementStatus dco_decode_dart_device_join_management_status(
    ...
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return DartDeviceJoinManagementStatus(
      joinSessionId: dco_decode_String(arr[0]),
      recipientDeviceId: dco_decode_String(arr[1]),
      phase: dco_decode_String(arr[2]),
      attempts: dco_decode_u_32(arr[3]),
      nextAttemptAtMs: dco_decode_i_64(arr[4]),
      failureCode: dco_decode_opt_String(arr[5]),
    );
  }
  ...
  DartHandleRecoveryAction dco_decode_dart_handle_recovery_action(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return DartHandleRecoveryAction.values[raw as int];
  }
  ...
  DartHandleRecoveryContext dco_decode_dart_handle_recovery_context(
    ...
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return DartHandleRecoveryContext(
      fullHandle: dco_decode_String(arr[0]),
      localIdentityId: dco_decode_opt_String(arr[1]),
      operation:
          dco_decode_opt_box_autoadd_dart_handle_recovery_operation_summary(
            arr[2],
          ),
      progress: dco_decode_opt_box_autoadd_dart_handle_recovery_progress(
        arr[3],
      ),
      allowedActions: dco_decode_list_dart_handle_recovery_action(arr[4]),
      blockedReason: dco_decode_opt_box_autoadd_dart_handle_recovery_error_code(
        arr[5],
      ),
    );
  }
  ...
  DartHandleRecoveryProgress dco_decode_dart_handle_recovery_progress(
    ...
    return DartHandleRecoveryProgress(
      ...
      allowedActions: dco_decode_list_dart_handle_recovery_action(arr[12]),
    );
  }
  ...
  DartIdentityCustodyBackend dco_decode_dart_identity_custody_backend(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return DartIdentityCustodyBackend.values[raw as int];
  }

  @protected
  DartIdentityCustodyState dco_decode_dart_identity_custody_state(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return DartIdentityCustodyState.values[raw as int];
  }
  ...
  DartIdentityCustodyStatus dco_decode_dart_identity_custody_status(
    ...
    if (arr.length != 10)
      throw Exception('unexpected arr length: expect 10 but see ${arr.length}');
    return DartIdentityCustodyStatus(
      identity: dco_decode_dart_identity_summary(arr[0]),
      backend: dco_decode_dart_identity_custody_backend(arr[1]),
      state: dco_decode_dart_identity_custody_state(arr[2]),
      ready: dco_decode_bool(arr[3]),
      rootControlAvailable: dco_decode_bool(arr[4]),
      pendingOperation: dco_decode_bool(arr[5]),
      storeId: dco_decode_opt_String(arr[6]),
      custodyIdentityId: dco_decode_opt_String(arr[7]),
      missing: dco_decode_list_String(arr[8]),
  ...
  dco_decode_dart_local_identity_deletion_ticket(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return DartLocalIdentityDeletionTicket(
      deletionId: dco_decode_String(arr[0]),
      ownerIdentityId: dco_decode_String(arr[1]),
      currentDid: dco_decode_String(arr[2]),
    );
  }
  ...
  DartMessageProcessingOutcome dco_decode_dart_message_processing_outcome(
    ...
    if (arr.length != 8)
      throw Exception('unexpected arr length: expect 8 but see ${arr.length}');
    return DartMessageProcessingOutcome(
      complete: dco_decode_bool(arr[0]),
      pendingCount: dco_decode_u_32(arr[1]),
      blockedCount: dco_decode_u_32(arr[2]),
      discardedCount: dco_decode_u_32(arr[3]),
      eventsApplied: dco_decode_u_32(arr[4]),
  ...
  DartMessageProcessingStatus dco_decode_dart_message_processing_status(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return DartMessageProcessingStatus.values[raw as int];
  }
  ...
  DartMessageProcessingUpdate dco_decode_dart_message_processing_update(
    ...
    if (arr.length != 5)
      throw Exception('unexpected arr length: expect 5 but see ${arr.length}');
    return DartMessageProcessingUpdate(
      eventId: dco_decode_String(arr[0]),
      status: dco_decode_dart_message_processing_status(arr[1]),
      changedConversationIds: dco_decode_list_String(arr[2]),
      committedIncomingMessages:
          dco_decode_list_dart_committed_incoming_message(arr[3]),
  ...
  DartMessageReceiveOutcome dco_decode_dart_message_receive_outcome(
    ...
    if (arr.length != 9)
      throw Exception('unexpected arr length: expect 9 but see ${arr.length}');
    return DartMessageReceiveOutcome(
      status: dco_decode_dart_message_sync_status(arr[0]),
      complete: dco_decode_bool(arr[1]),
      eventsReceived: dco_decode_u_32(arr[2]),
      pagesFetched: dco_decode_u_32(arr[3]),
      messagesHydrated: dco_decode_u_32(arr[4]),
      duplicatesSkipped: dco_decode_u_32(arr[5]),
      olderHistoryExcluded: dco_decode_bool(arr[6]),
      errorCode: dco_decode_opt_String(arr[7]),
  ...
  dco_decode_list_dart_device_join_management_status(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_dart_device_join_management_status)
        .toList();
  }
  ...
  List<DartHandleRecoveryAction> dco_decode_list_dart_handle_recovery_action(
    ...
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_dart_handle_recovery_action)
        .toList();
  }
  ...
  dco_decode_list_dart_local_identity_deletion_ticket(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_dart_local_identity_deletion_ticket)
        .toList();
  }
  ...
  dco_decode_list_dart_message_processing_update(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_dart_message_processing_update)
        .toList();
  }
  ...
  dco_decode_opt_box_autoadd_dart_handle_recovery_operation_summary(
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_dart_handle_recovery_operation_summary(raw);
  }
  ...
  dco_decode_opt_box_autoadd_dart_handle_recovery_progress(dynamic raw) {
    ...
    return raw == null
        ? null
        : dco_decode_box_autoadd_dart_handle_recovery_progress(raw);
  }
  ...
  sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerArcDartMessageProcessingSession(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return ArcDartMessageProcessingSessionImpl.frbInternalSseDecode(
      sse_decode_usize(deserializer),
      sse_decode_i_32(deserializer),
    );
  }
  ...
  sse_decode_box_autoadd_dart_daemon_subkey_public_proposal(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_dart_daemon_subkey_public_proposal(deserializer));
  }
  ...
  sse_decode_box_autoadd_dart_handle_recovery_operation_summary(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_dart_handle_recovery_operation_summary(deserializer));
  }
  ...
  sse_decode_box_autoadd_dart_handle_recovery_progress(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_dart_handle_recovery_progress(deserializer));
  }
  ...
  DartDaemonSubkeyPublicPackage sse_decode_dart_daemon_subkey_public_package(
    ...
    var var_keyAlgorithm = sse_decode_String(deserializer);
  ...
  DartDeviceJoinManagementStatus sse_decode_dart_device_join_management_status(
    ...
    var var_nextAttemptAtMs = sse_decode_i_64(deserializer);
    ...
    return DartDeviceJoinManagementStatus(
      ...
      nextAttemptAtMs: var_nextAttemptAtMs,
  ...
  DartHandleRecoveryAction sse_decode_dart_handle_recovery_action(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return DartHandleRecoveryAction.values[inner];
  }
  ...
  DartHandleRecoveryContext sse_decode_dart_handle_recovery_context(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_fullHandle = sse_decode_String(deserializer);
    var var_localIdentityId = sse_decode_opt_String(deserializer);
    var var_operation =
        sse_decode_opt_box_autoadd_dart_handle_recovery_operation_summary(
          deserializer,
        );
    var var_progress = sse_decode_opt_box_autoadd_dart_handle_recovery_progress(
      deserializer,
    );
    var var_allowedActions = sse_decode_list_dart_handle_recovery_action(
      deserializer,
    );
    var var_blockedReason =
        sse_decode_opt_box_autoadd_dart_handle_recovery_error_code(
          deserializer,
        );
    return DartHandleRecoveryContext(
      fullHandle: var_fullHandle,
      localIdentityId: var_localIdentityId,
  ...
  DartIdentityCustodyBackend sse_decode_dart_identity_custody_backend(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return DartIdentityCustodyBackend.values[inner];
  }
  ...
  DartIdentityCustodyState sse_decode_dart_identity_custody_state(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return DartIdentityCustodyState.values[inner];
  }
  ...
  DartIdentityCustodyStatus sse_decode_dart_identity_custody_status(
    ...
    var var_backend = sse_decode_dart_identity_custody_backend(deserializer);
    var var_state = sse_decode_dart_identity_custody_state(deserializer);
    var var_ready = sse_decode_bool(deserializer);
    var var_rootControlAvailable = sse_decode_bool(deserializer);
    var var_pendingOperation = sse_decode_bool(deserializer);
    var var_storeId = sse_decode_opt_String(deserializer);
    var var_custodyIdentityId = sse_decode_opt_String(deserializer);
    ...
    return DartIdentityCustodyStatus(
      ...
      state: var_state,
      ready: var_ready,
      rootControlAvailable: var_rootControlAvailable,
      pendingOperation: var_pendingOperation,
      storeId: var_storeId,
      custodyIdentityId: var_custodyIdentityId,
      missing: var_missing,
      warnings: var_warnings,
    );
  }
  ...
  sse_decode_dart_local_identity_deletion_ticket(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_deletionId = sse_decode_String(deserializer);
    var var_ownerIdentityId = sse_decode_String(deserializer);
    var var_currentDid = sse_decode_String(deserializer);
    return DartLocalIdentityDeletionTicket(
      deletionId: var_deletionId,
      ownerIdentityId: var_ownerIdentityId,
      currentDid: var_currentDid,
    );
  }
  ...
  DartMessageProcessingOutcome sse_decode_dart_message_processing_outcome(
    ...
    var var_pendingCount = sse_decode_u_32(deserializer);
    var var_blockedCount = sse_decode_u_32(deserializer);
    var var_discardedCount = sse_decode_u_32(deserializer);
    ...
    return DartMessageProcessingOutcome(
      ...
      blockedCount: var_blockedCount,
      discardedCount: var_discardedCount,
  ...
  DartMessageProcessingStatus sse_decode_dart_message_processing_status(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var inner = sse_decode_i_32(deserializer);
    return DartMessageProcessingStatus.values[inner];
  }
  ...
  DartMessageProcessingUpdate sse_decode_dart_message_processing_update(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_eventId = sse_decode_String(deserializer);
    var var_status = sse_decode_dart_message_processing_status(deserializer);
    var var_changedConversationIds = sse_decode_list_String(deserializer);
    var var_committedIncomingMessages =
        sse_decode_list_dart_committed_incoming_message(deserializer);
    var var_errorCode = sse_decode_opt_String(deserializer);
  ...
  DartMessageReceiveOutcome sse_decode_dart_message_receive_outcome(
    ...
    var var_complete = sse_decode_bool(deserializer);
    var var_eventsReceived = sse_decode_u_32(deserializer);
    ...
    return DartMessageReceiveOutcome(
      status: var_status,
      complete: var_complete,
      eventsReceived: var_eventsReceived,
  ...
  sse_decode_list_dart_device_join_management_status(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <DartDeviceJoinManagementStatus>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_dart_device_join_management_status(deserializer));
    }
    return ans_;
  }
  ...
  List<DartHandleRecoveryAction> sse_decode_list_dart_handle_recovery_action(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <DartHandleRecoveryAction>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_dart_handle_recovery_action(deserializer));
    }
    return ans_;
  }
  ...
  sse_decode_list_dart_local_identity_deletion_ticket(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <DartLocalIdentityDeletionTicket>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_dart_local_identity_deletion_ticket(deserializer));
    }
    return ans_;
  }
  ...
  sse_decode_list_dart_message_processing_update(SseDeserializer deserializer) {
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <DartMessageProcessingUpdate>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_dart_message_processing_update(deserializer));
    }
    return ans_;
  }
  ...
  sse_decode_opt_box_autoadd_dart_handle_recovery_operation_summary(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_dart_handle_recovery_operation_summary(
        deserializer,
      ));
    } else {
      return null;
  ...
  sse_decode_opt_box_autoadd_dart_handle_recovery_progress(
    ...
    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_dart_handle_recovery_progress(
        deserializer,
      ));
    } else {
      return null;
  ...
  sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerArcDartMessageProcessingSession(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
      (self as ArcDartMessageProcessingSessionImpl).frbInternalSseEncode(
        move: true,
      ),
      serializer,
    );
  ...
  void sse_encode_StreamSink_dart_message_processing_update_Sse(
    ...
    sse_encode_String(
      self.setupAndSerialize(
        codec: SseCodec(
          decodeSuccessData: sse_decode_dart_message_processing_update,
          decodeErrorData: sse_decode_AnyhowException,
        ),
      ),
      serializer,
  ...
  void sse_encode_box_autoadd_dart_daemon_subkey_public_proposal(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_dart_daemon_subkey_public_proposal(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_dart_handle_recovery_operation_summary(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_dart_handle_recovery_operation_summary(self, serializer);
  }
  ...
  void sse_encode_box_autoadd_dart_handle_recovery_progress(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_dart_handle_recovery_progress(self, serializer);
  }
  ...
  void sse_encode_dart_daemon_subkey_public_package(
    ...
    sse_encode_String(self.keyAlgorithm, serializer);
  ...
  void sse_encode_dart_device_join_management_status(
    ...
    sse_encode_i_64(self.nextAttemptAtMs, serializer);
  ...
  void sse_encode_dart_handle_recovery_context(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.fullHandle, serializer);
    sse_encode_opt_String(self.localIdentityId, serializer);
    sse_encode_opt_box_autoadd_dart_handle_recovery_operation_summary(
      self.operation,
      serializer,
    );
    sse_encode_opt_box_autoadd_dart_handle_recovery_progress(
      self.progress,
      serializer,
    );
    sse_encode_list_dart_handle_recovery_action(
      self.allowedActions,
      serializer,
    );
  ...
  void sse_encode_dart_identity_custody_status(
    ...
    sse_encode_dart_identity_custody_backend(self.backend, serializer);
    sse_encode_dart_identity_custody_state(self.state, serializer);
    sse_encode_bool(self.ready, serializer);
    sse_encode_bool(self.rootControlAvailable, serializer);
    sse_encode_bool(self.pendingOperation, serializer);
    sse_encode_opt_String(self.storeId, serializer);
    sse_encode_opt_String(self.custodyIdentityId, serializer);
  ...
  void sse_encode_dart_local_identity_deletion_ticket(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.deletionId, serializer);
    sse_encode_String(self.ownerIdentityId, serializer);
    sse_encode_String(self.currentDid, serializer);
  }
  ...
  void sse_encode_dart_message_processing_outcome(
    ...
    sse_encode_u_32(self.pendingCount, serializer);
    sse_encode_u_32(self.blockedCount, serializer);
    sse_encode_u_32(self.discardedCount, serializer);
  ...
  void sse_encode_dart_message_processing_update(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_String(self.eventId, serializer);
    sse_encode_dart_message_processing_status(self.status, serializer);
    sse_encode_list_String(self.changedConversationIds, serializer);
    sse_encode_list_dart_committed_incoming_message(
      self.committedIncomingMessages,
      serializer,
  ...
  void sse_encode_dart_message_receive_outcome(
    ...
    sse_encode_bool(self.complete, serializer);
    sse_encode_u_32(self.eventsReceived, serializer);
  ...
  void sse_encode_list_dart_device_join_management_status(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_dart_device_join_management_status(item, serializer);
    }
  }
  ...
  void sse_encode_list_dart_handle_recovery_action(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_dart_handle_recovery_action(item, serializer);
    }
  }
  ...
  void sse_encode_list_dart_local_identity_deletion_ticket(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_dart_local_identity_deletion_ticket(item, serializer);
    }
  }
  ...
  void sse_encode_list_dart_message_processing_update(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_dart_message_processing_update(item, serializer);
    }
  }
  ...
  void sse_encode_opt_box_autoadd_dart_handle_recovery_operation_summary(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_dart_handle_recovery_operation_summary(
        self,
        serializer,
      );
    }
  ...
  void sse_encode_opt_box_autoadd_dart_handle_recovery_progress(
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_dart_handle_recovery_progress(self, serializer);
    }
  }
...
@sealed
class ArcDartMessageProcessingSessionImpl extends RustOpaque
    implements ArcDartMessageProcessingSession {
  // Not to be used by end users
  ArcDartMessageProcessingSessionImpl.frbInternalDcoDecode(List<dynamic> wire)
    : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  ArcDartMessageProcessingSessionImpl.frbInternalSseDecode(
    BigInt ptr,
    int externalSizeOnNative,
  ) : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);
  ...
  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_increment_strong_count_ArcDartMessageProcessingSession,
    rustArcDecrementStrongCount: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_ArcDartMessageProcessingSession,
    rustArcDecrementStrongCountPtr: RustLib
        .instance
        .api
        .rust_arc_decrement_strong_count_ArcDartMessageProcessingSessionPtr,
  );
}
