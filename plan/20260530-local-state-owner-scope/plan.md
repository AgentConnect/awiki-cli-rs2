...
创建日期：2026-05-30  
恢复执行位置：步骤 08 review；继续时先读取 [steps/08-recover-upgrade.md](steps/08-recover-upgrade.md) 和当前 `git status`
...
| 08 | Recover/replace 和 workspace upgrade | 01-07 | DID history、v3 到 v4 workspace migration、legacy rebind 退役 | [steps/08-recover-upgrade.md](steps/08-recover-upgrade.md) | 必须 | review |
