...
创建日期：2026-05-30  
恢复执行位置：步骤 06 review；继续时先读取 [steps/06-groups-members.md](steps/06-groups-members.md) 和当前 `git status`
...
| 06 | 群组和成员 | 03 | identity-owned groups、members、snapshots、cached messages | [steps/06-groups-members.md](steps/06-groups-members.md) | 必须 | review |
