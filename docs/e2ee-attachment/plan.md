...
- 已修复问题对应 commit：
  ...
  - 本轮待提交：`anp/anp` typed group payload roundtrip、`e2ee-attachment-cli-rs2` internal manifest cache/redaction/download selection、`message-service` canonical group grant、`awiki-system-test` focused diagnostic/JWT reload、Plan/Step 台账更新。
- 阶段性验证证据：
