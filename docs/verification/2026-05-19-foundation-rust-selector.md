...
- Rust direct foundation/local contract targets passed 88 tests total:
  `anpsdk_contract` 16, `authsdk_contract` 15, `cli_http_profile_contract` 4,
  `cli_http_contract` 10, `command_catalog_schema_contract` 2,
  `cli_shell_core_contract` 20, `diagnostic_debug_contract` 5, `diagnostics_contract` 4,
  `cli_trace_contract` 9, and `content_wire_contract` 3.
...
- File-size evidence: the new system-test wrapper is 85 lines, and
  ...
  `cli_shell_core_contract.rs`, is 1183 lines, below the default 1200-line visibility
