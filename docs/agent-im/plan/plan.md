...
创建时间：2026-06-09  
恢复指针：Step 01、Step 02、Step 03、Step 04 已完成；恢复时从 Step 05 开始，或从第一个状态不是 `done` 的 Step 继续。
...
| 05 | awiki-deamon delegated inbox sync | Step 02、Step 04、Step 07 契约 | durable cursor、processed message、普通消息投递、E2EE opaque ignore | [steps/05-awiki-deamon-user-delegated-inbox-sync.md](steps/05-awiki-deamon-user-delegated-inbox-sync.md) | 必须 | committed |
