...
pub use self::dto::{
    ...
    ContactBindingState, DefaultIdentityChange, DeleteLocalIdentityResult,
    HandleRegistrationResult, HandleRegistrationState, IdentityMissingItem, IdentityReadiness,
    IdentitySelector, IdentitySummary, InitialProfile, Profile, ProfileAttribute, ProfilePatch,
    RecoverGeneratedIdentity, RecoverHandleLocalFinalizeRequest, RecoverHandleLocalResult,
    RecoverHandlePlan, RecoverHandlePlanRequest, RecoverHandleRequest, RecoverHandleResult,
    RecoverHandleState, RecoverLocalIdentitySummary, RecoverLocalUserState, RecoveredIdentity,
