...
pub use self::dto::{
    ...
    HandleRegistrationState, HostBackedAuthTokenPersistence, HostBackedDeviceIdentityMaterial,
    HostedIdentityMaterial, IdentityDeviceAuthorizationStatus, IdentityDeviceMode,
    ...
    InitialProfile, LegacyRegistryEpochAdoptionAuthority, LegacyUpgradeStatus, Profile,
