...
pub use crate::identity::{
    ...
    HandleRegistrationResult, HandleRegistrationState, HostBackedAuthTokenPersistence,
    HostBackedDeviceIdentityMaterial, HostedIdentityMaterial, IdentityDeviceAuthorizationStatus,
    IdentityDeviceRole, IdentityMissingItem, IdentityReadiness, IdentityRegistry,
    ...
    InitialProfile, LegacyRegistryEpochAdoptionAuthority, Profile, ProfileAttribute, ProfilePatch,
