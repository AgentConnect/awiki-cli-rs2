...
pub use crate::identity::{
    ...
    DeviceRevokeOutcomeCategory, DeviceRevokeRequest, DeviceRevokeResult, DeviceRevokeService,
    DeviceRevokeStatus, HandleRegistrationJoinRequired, HandleRegistrationResult,
