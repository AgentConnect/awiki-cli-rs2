...
pub struct NodeOpenOptions {
    ...
    pub client_version_product: String,
    pub client_version_release: String,
    pub client_version_version: String,
...
impl Clone for NodeOpenOptions {
    fn clone(&self) -> Self {
        Self {
            ...
            client_version_product: self.client_version_product.clone(),
            client_version_release: self.client_version_release.clone(),
            client_version_version: self.client_version_version.clone(),
