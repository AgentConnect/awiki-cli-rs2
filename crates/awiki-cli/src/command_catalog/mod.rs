...
pub fn cli_shell_role(raw: &str) -> CliShellRole {
    ...
    if matches!(
        name,
        "id.device.join.approve" | "onboarding.claim" | "onboarding.recover-legacy-claim"
    ) {
