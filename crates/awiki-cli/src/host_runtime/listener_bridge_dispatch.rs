use crate::host_runtime::bridge::BridgeRequest;
...
fn wire_identity(record: &RuntimeIdentityRecord) -> WireIdentity {
    WireIdentity {
        did: record.did.clone(),
    }
}

fn bridge_wire_identity(record: &RuntimeIdentityRecord) -> BridgeWireIdentity {
    BridgeWireIdentity {
