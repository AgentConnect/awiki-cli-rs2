use crate::host_runtime::bridge::{handle_bridge_connection_once, BridgeRequest};
use crate::host_runtime::listener_bridge_dispatch::build_bridge_rpc_call;
use crate::host_runtime::listener_identity_record::RuntimeIdentityRecord;
use crate::host_runtime::listener_service_did::disconnected_websocket_session_error;
...
pub struct ListenerBridgeSession {
    ...
    pub record: Option<RuntimeIdentityRecord>,
    pub has_client: bool,
}

impl ListenerBridgeSession {
    pub fn connected(identity_name: impl Into<String>, record: RuntimeIdentityRecord) -> Self {
        Self {
    ...
    pub fn disconnected(
        ...
        record: Option<RuntimeIdentityRecord>,
    ) -> Self {
        Self {
            identity_name: identity_name.into(),
            record,
