use crate::dto::{
    ...
    secure::{
        ...
        DartGroupSecureStatus, DartSecureDelivery, DartSecureOutboxEntry,
        DartSecureOutboxResult, DartSecureOutboxStatus, DartSecureProblem,
        DartSecureProblemCode,
    },
};
...
impl From<im_core::secure::SecureProblemCode> for DartSecureProblemCode {
    fn from(value: im_core::secure::SecureProblemCode) -> Self {
        match value {
            ...
            im_core::secure::SecureProblemCode::TransportUnavailable => {
